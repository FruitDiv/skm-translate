...
data.table::fwrite(dt, '../intermediate/FastOMA2_ath-pairs.txt', sep = '\t')
zip(zipfile = "../intermediate/FastOMA2_ath-pairs.txt.zip", files = "../intermediate/FastOMA2_ath-pairs.txt")
file.remove("../intermediate/FastOMA2_ath-pairs.txt")
