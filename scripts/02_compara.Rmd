...
data.table::fwrite(comparaPlants.hc, '../intermediate/comparaPlants.high_confidence.txt', sep = '\t')
zip(zipfile = "../intermediate/comparaPlants.high_confidence.txt.zip", files = "../intermediate/comparaPlants.high_confidence.txt")
file.remove("../intermediate/comparaPlants.high_confidence.txt")
...
data.table::fwrite(comparaPlants.filtered, '../intermediate/comparaPlants_high_confidence_ath_pairs.txt', sep = '\t')
zip(zipfile = "../intermediate/comparaPlants_high_confidence_ath_pairs.txt.zip", files = "../intermediate/comparaPlants_high_confidence_ath_pairs.txt")
file.remove("../intermediate/comparaPlants_high_confidence_ath_pairs.txt")
...
data.table::fwrite(df, '../intermediate/comparaPlants_hc-to-ath.txt', sep = '\t')
zip(zipfile = "../intermediate/comparaPlants_hc-to-ath.txt.zip", files = "../intermediate/comparaPlants_hc-to-ath.txt")
file.remove("../intermediate/comparaPlants_hc-to-ath.txt")
