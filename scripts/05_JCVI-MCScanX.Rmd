...
data.table::fwrite(df, '../intermediate/JCVI_MCScanX_plants.txt', sep = '\t')
zip(zipfile = "../intermediate/JCVI_MCScanX_plants.txt.zip", files = "../intermediate/JCVI_MCScanX_plants.txt")
file.remove("../intermediate/JCVI_MCScanX_plants.txt")
