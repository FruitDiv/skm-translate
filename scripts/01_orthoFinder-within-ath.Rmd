...
data.table::fwrite(df.pairs, '../intermediate/orthofinder_ath-within.txt', sep = '\t')
zip(zipfile = "../intermediate/orthofinder_ath-within.txt.zip", files = "../intermediate/orthofinder_ath-within.txt")
file.remove("../intermediate/orthofinder_ath-within.txt")
...
data.table::fwrite(df_wide, '../intermediate/orthofinder_ath-within_compara-wide.txt', sep = '\t')
zip(zipfile = "../intermediate/orthofinder_ath-within_compara-wide.txt.zip", files = "../intermediate/orthofinder_ath-within_compara-wide.txt")
file.remove("../intermediate/orthofinder_ath-within_compara-wide.txt")
...
data.table::fwrite(df_wide, '../intermediate/orthofinder_ath-within_plaza-wide.txt', sep = '\t')
zip(zipfile = "../intermediate/orthofinder_ath-within_plaza-wide.txt.zip", files = "../intermediate/orthofinder_ath-within_plaza-wide.txt")
file.remove("../intermediate/orthofinder_ath-within_plaza-wide.txt")
...
data.table::fwrite(df_wide, '../intermediate/orthofinder_ath-within_OrthoDB-wide.txt', sep = '\t')
zip(zipfile = "../intermediate/orthofinder_ath-within_OrthoDB-wide.txt.zip", files = "../intermediate/orthofinder_ath-within_OrthoDB-wide.txt")
file.remove("../intermediate/orthofinder_ath-within_OrthoDB-wide.txt")
